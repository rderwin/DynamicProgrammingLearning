        ...
        {Array.from({ length: n + 1 }, (_, i) => {
          ...
          return (
            <div key={i} className="flex flex-col items-center gap-1.5">
              <div className="text-[10px] font-mono text-slate-400 font-medium">{i}</div>
              <div
                className={`
                  ...
                  ${
                    isWritten
                      ? "bg-green-100 border-2 border-green-500 text-green-700 shadow-md shadow-green-500/20"
                      : isRead
                        ? "bg-amber-50 border-2 border-amber-400 text-amber-700 shadow-md shadow-amber-400/20"
                        : value !== undefined
